...
def plotArithSep(modelName, plotData, typeWise=False):
    ...
    axs1.scatter(np.array(plotData.arithX), np.array(plotData.arithY), color=plotColor['arith'], s=1)
    axs1.scatter(np.array(plotData.fparithX), np.array(plotData.fparithY), color=plotColor['fparith'], s=1)
    axs1.scatter(np.array(plotData.varithX), np.array(plotData.varithY), color=plotColor['varith'], s=1)
    ...
    axs2.scatter(np.array(plotData.arithX), np.array(plotData.arithY), color=plotColor['arith'], s=1)
    ...
    axs3.scatter(np.array(plotData.fparithX), np.array(plotData.fparithY), color=plotColor['fparith'], s=1)
